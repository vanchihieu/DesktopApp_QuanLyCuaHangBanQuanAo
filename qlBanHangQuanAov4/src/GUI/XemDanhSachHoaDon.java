...
public class XemDanhSachHoaDon extends JPanel implements ActionListener{
	...
	public XemDanhSachHoaDon(ManHinhChinh main) {
		this.main = main;
...
//            Chi tiết hóa đơn
	...
	public String getMaKH(String ten) {
		for (KhachHang kh : KhachHang_dao.getAllKhachHang()) {
	...
	public String getMaNV(String ten) {
		for (NhanVien nv : NhanVien_Dao.getAllNhanVien()) {
	...
	public String getSDTKhachHang(String ten) {
		for (KhachHang kh : KhachHang_dao.getAllKhachHang()) {
			if(kh.getTenKhachHang().equals(ten))
	...
	public Double getDonGiaSP(String ma) {
		for (SanPham sanPham : SanPham_dao.getAllSanPham()) {
	...
	public String ChecktaoSQL() {
		...
		if(!txtNgayLap.getText().isEmpty()) {
			if(having.contains("kh.soDienThoai"))
				having += " and hd.ngayLap = '" + txtNgayLap.getText()+"'";
			else
				having +=" hd.ngayLap = '" + txtNgayLap.getText()+"'";
		}
		if(!txtNguoiLap.getText().isEmpty()) {
			if(having.contains("and") || sql.contains("kh.soDienThoai") || sql.contains("hd.ngayLap"))
				having += " and nv.tenNhanVien = N'" + txtNguoiLap.getText()+"'";
			else
				having += " nv.tenNhanVien = N'" + txtNguoiLap.getText()+"'";
		}
		if(!txtTenKH.getText().isEmpty()) {
			if(sql.contains("and") || sql.contains("kh.soDienThoai") || sql.contains("hd.ngayLap")
