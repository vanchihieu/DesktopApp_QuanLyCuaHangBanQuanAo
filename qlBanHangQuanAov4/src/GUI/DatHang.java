...
//			}
			...
			if(tableModel.getRowCount() == 0 || txtSDT.getText().equals("")) {
				...
				String sdt = txtSDT.getText();
				String mapdh = taoMaPhieuDatHang();
				String khachhang = "";
				String nguoilap = "";
				for (KhachHang kh : dsKH) {
					if(sdt.equals(kh.getSoDienThoai())) {
				...
				if(PhieuDatHang_dao.create(pdh)) {
					for(int i = 0; i < totalRow;i++) {
						...
						ChiTietPhieuDatHang ctpdh = new ChiTietPhieuDatHang(new PhieuDatHang(mapdh),
...
//			JOptionPane.showMessageDialog(this, taoMaPhieuDatHang());
			...
			Form_ScanDatHang FScan = new Form_ScanDatHang(this);
