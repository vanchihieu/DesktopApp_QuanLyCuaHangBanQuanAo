...
public class QuanLyKhuyenMai extends JPanel implements ActionListener{
	...
	public QuanLyKhuyenMai(ManHinhChinh main) {
		this.main = main;
					...
					if(kiemTraNgayHopLe(LocalDate.of(Integer.valueOf(ngayBD[0]), Integer.valueOf(ngayBD[1]), Integer.valueOf(ngayBD[2])),
						...
						if(KhuyenMai_dao.create(km)) {
							for(int i = 0; i<row;i++) {
								...
								ChiTietKhuyenMai ctkm = new ChiTietKhuyenMai(new KhuyenMai(maKM),
										new SanPham(masp),
										phantram);
...
//					JOptionPane.showMessageDialog(this, );	
	...
	public void demSoLuongCTKM(String maKM, int soluong) {
	...
	public boolean kiemTraSPTonTaiKM(String maSP) {
