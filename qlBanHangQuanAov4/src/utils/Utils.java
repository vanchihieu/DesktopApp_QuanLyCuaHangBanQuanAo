...
public class Utils {
	...
	public static final String quanLySanPhamMenuItem = "Quản lý quần áo";
	public static final String timKiemSanPhamMenuItem = "Tìm kiếm quần áo";
	public static final String thongKeSanPhamMenuItem = "Thống kê quần áo";
	...
	public static final String taoTaiKhoanMenuItem = "Tạo tài khoản";
